...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create glass-e317
  fly apps create glass-e317-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app glass-e317
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app glass-e317-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'glass-e317-staging' does not match app name in config file 'glass-e317'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name glass-e317-db
  fly postgres attach --app glass-e317 glass-e317-db

  fly postgres create --name glass-e317-staging-db
  fly postgres attach --app glass-e317-staging glass-e317-staging-db
  ```
